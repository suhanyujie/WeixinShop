...
class oauth {
    ...
    public function __construct($type) {
        ...
        //导入接口文件
        include_once COMMON_PATH . 'Pinlib/oauth/' . $type . '/' . $type . '.php';
        $om_class  = $type . '\\' . $type . '_oauth';
    ...
    private function _oauth_visitor() {
        include_once (COMMON_PATH . '/Pinlib/UserVisitor.class.php');
        return new Common\Pinlib\UserVisitor();
    }
