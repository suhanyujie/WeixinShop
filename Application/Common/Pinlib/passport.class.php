...
class passport {
    ...
    public function __construct($name) {
        $file = COMMON_PATH . 'Pinlib/passport/' . $name . '.php';
        include $file;
        $class = 'Common\\Pinlib\\passport\\' . $name . 'Passport';
        $this->_us = new $class();
    }

    static function uc($name) {
        include COMMON_PATH . 'Pinlib/passport/' . $name . '.php';
        $class = 'Common\\Pinlib\\passport\\' . $name . 'Passport';
        return new $class();
    }
