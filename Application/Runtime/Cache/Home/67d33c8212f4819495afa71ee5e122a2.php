...
<div id="page-contents">
    <div id="header" class="clear clearfix">
        <div class="back"></div>
        <div class="title-fr">我的关注</div>
    </div>
    <div id="header-placeholder">&nbsp;</div>
    <div id="content" class="clear clearfix">        
        <div class="clear clearfix orders">
            <div class="clear clearfix orders-container">
                <?php if(!empty($lists)): if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="order_form">
                            <div class="con">
                                <p class="ware_pic">
                                    <a href="<?php echo U('Item/index',array('id'=>$vo['id']));?>">
                                        <img src="<?php echo attach(get_thumb($vo['img'], '_s'), 'item');?>" width="40">
                                    </a>
                                </p>
                                <p class="ware_text"><a href="<?php echo U('Item/index',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a>
                                </p>
                                <p class="price">价格:
