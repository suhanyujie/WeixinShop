...
<div id="page-contents">
    ...
    <div id="content">
        <form name="" id="register_form" method="post" action="<?php echo U('User/verifyMobile');?>">
            <div style="line-height: 2; font-size: 16px;">欢迎，<?php echo ($_SESSION['user_info']['nickname']); ?>注册，新用户请输入手机号</div>
            ...
            <input name="uid" value="<?php echo ($_SESSION['user_info']['id']); ?>" type="hidden">
        </form>
    </div>
    <div class="bot_nav">
