        ...
        <form method="post" action="<?php echo U('User/addaddress');?>" id="address_form">
            ...
            <ul class="padding-content" id="address_form">
                <li>
                    ...
                    <p>
                    <input value="<?php echo ($info["consignee"]); ?>" name="consignee" id="consignee" class="text" type="text" required="required" />
                    </p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p>
                    <input value="<?php echo ($info["address"]); ?>" name="address" id="address" class="text width1" type="text" required="required" />
                    </p>
                </li>
                <li>
                    <p class="title">手机号码</p>
                    <p>
                    <input value="<?php echo ($info["mobile"]); ?>" id="phone_mob" name="phone_mob" class="text" type="text" required="required" />
                    </p>
                </li>
            </ul>
...
$(function() {
    ...
    $.address("s1", "s2", "s3", "<?php echo ($info["sheng"]); ?>", "<?php echo ($info["shi"]); ?>", "<?php echo ($info["qu"]); ?>");
