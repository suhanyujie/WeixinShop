...
<div id="page-contents">
        ...
        <div class="content clear clearfix">
            ...
            <div class="search-fr">
                <form class="clear clearfix" action="<?php echo U('Search/index');?>" method="get">                    
                    ...
                    <div class="search"><input class="text-input" autocomplete="off" placeholder="<?php echo C('pin_default_keyword');?>" value="<?php echo ($q); ?>" name="q"></div>
    ...
    <div class="plist clear clearfix">
        ...
        <ul class="list clear clearfix" id="products_list">
            <?php if(is_array($item_list)): $i = 0; $__LIST__ = $item_list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li class="item">
                <div class="main">
                    <div class="img">
    ...
    <div class="bot_nav">
        <ul class="clear clearfix">
            ...
            <li class="item cur" src="<?php echo U('Search/index?type=item');?>">
...
window.onload = function(){
    ...
    if(hasPages) {
        ...
        $(window).scroll(function() {
            ...
            if (scrollPos + $(window).height() + 10 >= $(document).height()) {
                if (p < totalPages && !stop) {
                    ...
                    $.getJSON('<?php echo U('Search/index', array('q'=>$q, 't'=>$t));?>', data, function(data){
                        stop = false;
                        $('#J_wall_loading').hide();
