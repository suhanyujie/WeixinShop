...
<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
    ...
    <tr id="ad_image" class="bill_media">
		...
		<?php if($info["type"] == 'image'): if(!empty($info['content'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo ($img_dir); echo ($info["content"]); ?>"><img src="/Public/images/filetype/image_s.gif" /></span><?php endif; endif; ?>
		</td>
    </tr>
