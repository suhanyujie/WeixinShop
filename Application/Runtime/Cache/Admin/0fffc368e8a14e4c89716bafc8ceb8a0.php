...
<head>
	...
	var SELF = '/index.php?g=admin&m=ad&a=index&menuid=12';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('ad/ajax_edit');?>">
        ...
        <tbody>
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><?php echo ($ad_type_arr[$val['type']]); if($val["type"] == 'image'): if(!empty($val['content'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo ($img_dir); echo ($val["content"]); ?>"><img src="/Public/images/filetype/image_s.gif" /></span><?php endif; endif; ?></td>
