...
<div class="dialog_content">
	...
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<select name='uid'>
			<option>取消会员组</option>
			<?php if(is_array($info["cate"])): $i = 0; $__LIST__ = $info["cate"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value='<?php echo ($cate["id"]); ?>' <?php if($info['uid'] == $cate['id']): ?>selected<?php endif; ?>><?php echo ($cate["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			</td>
	    ...
	    <tr>
			...
			<td>
				...
				<?php if(!empty($info['img'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo avatar($info['id'], 32);?>"><img src="/statics/images/filetype/image_s.gif" /></span><?php endif; ?>
            </td>
		</tr>
        <tr>
			<th>会员邮箱 :</th>
