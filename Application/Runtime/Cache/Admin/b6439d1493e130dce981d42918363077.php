...
<head>
	...
	var SELF = '/index.php?g=admin&m=item&a=index&menuid=52';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<div class="pad_lr_10" >
    ...
    <table width="100%" cellspacing="0" class="search_form">
        <tbody>
            ...
            &nbsp;&nbsp;是否限购 :  
            <select name="is_xiangou" >
            <option value="">--所有--</option>
            <option <?php if($search["is_xiangou"] == 1): ?>selected=''<?php endif; ?> value="1">限购</option>
            <option <?php if($search["is_xiangou"] == 0): ?>selected=''<?php endif; ?> value="0">非限购</option>
            </select>
                    <div class="bk8"></div>
