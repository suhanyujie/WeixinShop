...
<head>
	...
	<script>
	var URL = '/index.php/admin-item_order';
	var SELF = '/index.php?g=admin&m=item_order&a=edit&id=39&menuid=296';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
.tblist thead tr th, .tblist tbody tr.tblist_th td {
    background: url("/Public/images/tblistthbg.gif") repeat-x scroll 0 0 transparent;
		...
		<div class="mt10" style="text-align:center;">
		  <?php switch($info["status"]): case "1": ?><!-- 待付款-->
               ...
               <a data-height="130" data-width="650"
                 data-id="add" data-title="发货管理" data-uri="<?php echo U('item_order/fahuo',array('id'=>$info['id']));?>" href="javascript:void(0);" class="add fb J_showdialog"> 	<input type="button" value="发货" id="dosubmit" name="dosubmit" class="btn btn_submit" ></a><?php break;?>  
                <?php case "3": ?><!-- 待收货 -->
