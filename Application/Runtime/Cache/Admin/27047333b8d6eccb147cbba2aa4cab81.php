...
<head>
	...
	var SELF = '/index.php?g=admin&m=item&a=add&menuid=249';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
...
<form id="info_form" action="<?php echo u('item/add');?>" method="post" enctype="multipart/form-data">
    <div class="pad_lr_10">
        <div class="col_tab">
                ...
                <div class="content_list pad_10">
                    <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
                        <tr>
                            ...
                            <td>
                                <select class="J_cate_select mr10" data-pid="0" data-uri="<?php echo U('item_cate/ajax_getchilds', array('type'=>0));?>" data-selected=""></select>
                        ...
                        <tr>
                            <tr>
                                <th>排序 :</th>
                                <td>
                                    <input type="text" name="ordid" class="input-text" value="<?php echo ($info["ordid"]); ?>" style="width:50px;"> 数字越大越靠前</td>
                            </tr>
                            <!--    <th>颜色 :</th>
            ...
            -->
                            ...
                            <tr>
                                <th>会员价格 :</th>
                                <td>
                                    <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><span style="display:inline-block" id='J_user_price'>
                <input type="hidden" name="user_price[cate_id][]" value="<?php echo ($cate["id"]); ?>">
                <?php echo ($cate["name"]); ?><input class='user_price' onkeyup="this.value=this.value.replace(/[^0-9.\-]/g,'')" onafterpaste="this.value=this.value.replace(/[^0-9\-.]/g,'')" type="text" name="user_price[price][]" class="input-text" size="10" value="-1"> &nbsp </span><?php endforeach; endif; else: echo "" ;endif; ?>
                                    <br/>
                ...
                <div class="content_list pad_10 hidden">
                    <table width="100%" cellpadding="2" cellspacing="1" class="table_form" id="first_upload_file">
                        <tbody class="uplode_file">
                            <tr>
                                <th width="100">
                                    <a href="javascript:void(0);" class="blue" onclick="add_file();"><img src="/Public/css/admin/bgimg/tv-expandable.gif" />
                                    </a> 上传文件 :</th>
                                <td>
        ...
        <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
                ...
                <div class="content_list pad_10 hidden">
                    <table width="100%" cellpadding="2" cellspacing="1" class="table_form" id="item_attr">
                        <tbody class="add_item_attr">
                            <tr>
                                <th width="210">
                                    <a href="javascript:void(0);" class="blue" onclick="add_attr();"><img src="/Public/css/admin/bgimg/tv-expandable.gif" />
                                    </a> 属性名 :
            ...
            <div class="mt10">
                <input type="submit" value="<?php echo L('submit');?>" class="btn btn_submit">
            </div>
        </div>
    </div>
...
<table id="next_upload_file" style="display:none;">
    <tbody class="uplode_file">
        <tr>
            <th width="100">
                <a href="javascript:void(0);" onclick="del_file_box(this);" class="blue"><img src="/Public/css/admin/bgimg/tv-collapsable.gif" />
                </a>上传文件 :</th>
            <td>
                <input type="file" name="imgs[]">
            </td>
...
<table id="hidden_attr" style="display:none;">
    <tbody class="add_item_attr">
        <tr>
            <th width="200">
                <a href="javascript:void(0);" class="blue" onclick="del_attr(this);"><img src="/Public/css/admin/bgimg/tv-collapsable.gif" />
                </a>属性名 :
                <input type="text" name="attr[name][]" class="input-text" size="20">
            </th>
            <td>属性值 :
