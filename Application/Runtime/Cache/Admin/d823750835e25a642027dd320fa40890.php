    ...
    <table width="100%" class="table_form">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="javascript:;" class="color_picker_btn"><img class="J_color_picker" data-it="J_name" data-ic="J_color" src="/Public/images/color.png"></a>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <?php if(!empty($info['img'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo attach($info['img'], 'item_cate');?>"><img src="/Public/images/filetype/image_s.gif" /></span><?php endif; ?></td>
        </tr>
        <tr>
