...
<head>
	...
	<script>
	var URL = '/index.php/admin-user_category';
	var SELF = '/index.php?g=admin&m=user_category&a=index&menuid=318';
	var ROOT_PATH = '';
	var APP	 =	 '/index.php';
	//语言项目
	var lang = new Object();
    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="80" align="center"><span data-tdtype="order_by" data-field="name">会员组名</span></th>
                <!-- <th align="center"><span data-tdtype="order_by" data-field="discount">折扣率</span></th>-->
                <th align="center"><span data-tdtype="order_by" data-field="score">积分加成率</span></th>
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <!-- <td align="center"><span data-tdtype="edit" data-field="discount" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["discount"]); ?></span></td>-->
                <td align="center"><span data-tdtype="edit" data-field="score" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["score"]); ?></span></td>
                
              <!--  <td align="center"><img data-tdtype="toggle" data-id="<?php echo ($val["id"]); ?>" data-field="daren" data-value="<?php echo ($val["daren"]); ?>" src="/Public/images/admin/toggle_<?php if($val["daren"] == 0): ?>disabled<?php else: ?>enabled<?php endif; ?>.gif" /></td>-->
              ...
              <td align="left"><span data-tdtype="edit" data-field="ordid" data-id="<?php echo ($val["id"]); ?>" class="tdedit" style="color:<?php echo ($val["colors"]); ?>;"><?php echo ($val["ordid"]); ?></span></td>
                <td align="center"><img data-tdtype="toggle" data-id="<?php echo ($val["id"]); ?>" data-field="status" data-value="<?php echo ($val["status"]); ?>" src="/Public/images/admin/toggle_<?php if($val["status"] == 0): ?>disabled<?php else: ?>enabled<?php endif; ?>.gif" /></td>
                <td align="center">
