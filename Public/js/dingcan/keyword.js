...
function edit_reply(id,t){
	...
	$("input.rep_type_"+kk+"[name='rep_type']").on('click',function(){
		if(tt!=$(this).val()){
			tt = $(this).val();
			for(var i=1;i<=4;i++){
				$("#type_box_"+kk+"_"+i).hide();
...
$(document).ready(function (){
	...
	$("input[name='kar_name']").on('change',function(){ isdo = true; });
	$("input[name='is_position']").on('change',function(){ isdo = true; });
	$("input[name='rep_type']").on('change',function(){ isdo = true; });
